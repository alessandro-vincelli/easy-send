...
import it.av.es.model.BasicEntity;
import it.av.es.service.ApplicationService;
...
public class ApplicationServiceHibernate<T extends BasicEntity> extends JpaDaoSupport implements ApplicationService<T> {
    ...
    public T save(T obj) {
        if (obj == null) {
            throw new EasySendException("Object is null");
        }
        ...
        try {
            ...
            throw new EasySendConcurrentModificationException(e);
    ...
    public List<T> findFullText(String query) {
        throw new EasySendException("not implememted yet");
    }
